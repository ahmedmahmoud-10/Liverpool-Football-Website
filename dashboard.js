...
const CONFIG = {
  API_KEY: '1d2c345af8e0420cadb1c4a03bd2d73a', // Your personal API key
  LIVERPOOL_TEAM_ID: 64, // Liverpool FC team ID
  PREMIER_LEAGUE_ID: 2021, // Premier League (PL) - Note: Free tier might have restrictions
  UPDATE_INTERVAL: 60000, // 60 seconds
  USE_DEMO_DATA: true // Set to true to use demo data
};
...
class LiverpoolDashboard {
  ...
  async testAPIConnection() {
    console.log('Testing with Liverpool team ID 64...');
    const testUrl = `https://api.football-data.org/v4/teams/64/matches?status=SCHEDULED`;
    ...
    console.log('API Test Success! Got', data.matches?.length || 0, 'matches');
    return data;
  }
